...
public interface IStreams {
    ...
    public class StreamError {
        ...
        public static StreamError lastOperationFailed(global::ProxyWorld.wit.imports.wasi.io.v0_2_0.IError.Error lastOperationFailed) {
        ...
        public global::ProxyWorld.wit.imports.wasi.io.v0_2_0.IError.Error AsLastOperationFailed
        {
            get
            {
                if (Tag == LAST_OPERATION_FAILED)
                return (global::ProxyWorld.wit.imports.wasi.io.v0_2_0.IError.Error)value!;
                else
    ...
    public class InputStream: IDisposable {
        ...
        public   unsafe byte[] Read(ulong len)
        {
            ...
            fixed (uint* retAreaByte0 = &retArea[0])
            {
                ...
                Result<byte[], global::ProxyWorld.wit.imports.wasi.io.v0_2_0.IStreams.StreamError> lifted6;
                ...
                switch (new Span<byte>((void*)(ptr + 0), 1)[0]) {
                    case 0: {
                        ...
                        lifted6 = Result<byte[], global::ProxyWorld.wit.imports.wasi.io.v0_2_0.IStreams.StreamError>.ok(array);
                        break;
                    }
                    case 1: {

                        global::ProxyWorld.wit.imports.wasi.io.v0_2_0.IStreams.StreamError lifted;

                        switch (new Span<byte>((void*)(ptr + 4), 1)[0]) {
                            case 0: {
                                var resource = new global::ProxyWorld.wit.imports.wasi.io.v0_2_0.IError.Error(new global::ProxyWorld.wit.imports.wasi.io.v0_2_0.IError.Error.THandle(BitConverter.ToInt32(new Span<byte>((void*)(ptr + 8), 4))));

                                lifted = global::ProxyWorld.wit.imports.wasi.io.v0_2_0.IStreams.StreamError.lastOperationFailed(resource);
                                break;
                            }
                            case 1: {

                                lifted = global::ProxyWorld.wit.imports.wasi.io.v0_2_0.IStreams.StreamError.closed();
                                break;
                            }
                        ...
                        lifted6 = Result<byte[], global::ProxyWorld.wit.imports.wasi.io.v0_2_0.IStreams.StreamError>.err(lifted);
                        break;
                    }
        ...
        public   unsafe ulong Skip(ulong len)
        {
            ...
            fixed (ulong* retAreaByte0 = &retArea[0])
            {
                ...
                Result<ulong, global::ProxyWorld.wit.imports.wasi.io.v0_2_0.IStreams.StreamError> lifted6;

                switch (new Span<byte>((void*)(ptr + 0), 1)[0]) {
                    case 0: {

                        lifted6 = Result<ulong, global::ProxyWorld.wit.imports.wasi.io.v0_2_0.IStreams.StreamError>.ok(unchecked((ulong)(BitConverter.ToInt64(new Span<byte>((void*)(ptr + 8), 8)))));
                        break;
                    }
                    case 1: {
                        ...
                        switch (new Span<byte>((void*)(ptr + 8), 1)[0]) {
                            case 0: {
                                var resource = new global::ProxyWorld.wit.imports.wasi.io.v0_2_0.IError.Error(new global::ProxyWorld.wit.imports.wasi.io.v0_2_0.IError.Error.THandle(BitConverter.ToInt32(new Span<byte>((void*)(ptr + 12), 4))));
                        ...
                        lifted6 = Result<ulong, global::ProxyWorld.wit.imports.wasi.io.v0_2_0.IStreams.StreamError>.err(lifted);
                        break;
                    }
    ...
    public class OutputStream: IDisposable {
        ...
        public   unsafe void Write(byte[] contents)
        {
            ...
            fixed (uint* retAreaByte0 = &retArea[0])
            {
                ...
                Result<None, global::ProxyWorld.wit.imports.wasi.io.v0_2_0.IStreams.StreamError> lifted6;

                switch (new Span<byte>((void*)(ptr + 0), 1)[0]) {
                    case 0: {

                        lifted6 = Result<None, global::ProxyWorld.wit.imports.wasi.io.v0_2_0.IStreams.StreamError>.ok(new global::ProxyWorld.None());
                        break;
                    }
                    case 1: {
                        ...
                        lifted6 = Result<None, global::ProxyWorld.wit.imports.wasi.io.v0_2_0.IStreams.StreamError>.err(lifted);
                        break;
                    }
        ...
        public   unsafe ulong Splice(global::ProxyWorld.wit.imports.wasi.io.v0_2_0.IStreams.InputStream src, ulong len)
        {
            var handle = this.Handle;
            ...
            fixed (ulong* retAreaByte0 = &retArea[0])
            {
                ...
                Result<ulong, global::ProxyWorld.wit.imports.wasi.io.v0_2_0.IStreams.StreamError> lifted7;

                switch (new Span<byte>((void*)(ptr + 0), 1)[0]) {
                    case 0: {

                        lifted7 = Result<ulong, global::ProxyWorld.wit.imports.wasi.io.v0_2_0.IStreams.StreamError>.ok(unchecked((ulong)(BitConverter.ToInt64(new Span<byte>((void*)(ptr + 8), 8)))));
                        break;
                    }
                    case 1: {
                        ...
                        lifted7 = Result<ulong, global::ProxyWorld.wit.imports.wasi.io.v0_2_0.IStreams.StreamError>.err(lifted);
                        break;
                    }
        ...
        public   unsafe ulong BlockingSplice(global::ProxyWorld.wit.imports.wasi.io.v0_2_0.IStreams.InputStream src, ulong len)
        {
            var handle = this.Handle;
            var handle0 = src.Handle;
