...
namespace ProxyWorld.wit.imports.wasi.clocks.v0_2_0
{
    public static class MonotonicClockInterop {
        ...
        public  static unsafe global::ProxyWorld.wit.imports.wasi.io.v0_2_0.IPoll.Pollable SubscribeInstant(ulong when)
        {
        ...
        public  static unsafe global::ProxyWorld.wit.imports.wasi.io.v0_2_0.IPoll.Pollable SubscribeDuration(ulong when)
        {
