...
namespace ProxyWorld.wit.imports.wasi.io.v0_2_0
{
    public static class PollInterop {
        ...
        public  static unsafe uint[] Poll(List<global::ProxyWorld.wit.imports.wasi.io.v0_2_0.IPoll.Pollable> @in)
        {
            ...
            for (int index = 0; index < @in.Count; ++index) {
                global::ProxyWorld.wit.imports.wasi.io.v0_2_0.IPoll.Pollable element = @in[index];
